      ...
      <div className="flex gap-3 overflow-x-auto pb-2">
        {COLUMNS.map((column) => {
          ...
          return (
            <div
              key={column.key}
              className="flex w-[240px] shrink-0 flex-col rounded-lg border border-charcoal-200 bg-white"
            >
              <div
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="text-sm font-semibold text-charcoal-800">{column.label}</span>
                  <span
                ...
                <p className="mt-1 text-lg font-bold text-charcoal-900">{formatCurrencyShort(columnAmount)}</p>
              </div>
                  ...
                  columnDeals.map((deal) => (
                    ...
                    >
                      <div className="flex items-start justify-between gap-2">
                        <p className="text-sm font-semibold text-charcoal-900">{deal.accountName}</p>
                        <span className="shrink-0 text-sm font-bold text-iris-600">
